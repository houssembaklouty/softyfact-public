...
@section('meta')
    <title>Page introuvable — SoftyFact</title>
@endsection
...
@section('body')
    ...
    <main class="flex items-center justify-center min-h-[calc(100vh-12rem)] px-4">
        <div class="text-center max-w-lg">
            <p class="text-8xl font-extrabold text-cm-primary/20">404</p>
            <h1 class="mt-4 text-2xl font-bold text-gray-900 sm:text-3xl">{{ __('errorPageNotFoundTitle') }}</h1>
            <p class="mt-3 text-gray-500">{{ __('errorPageNotFoundMessage') }}</p>
